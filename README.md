...
## PF-01.2 Localization Engine

تمت إضافة دعم أولي لتعدد اللغات عبر `frontend/i18n.js` و `backend/app/core/localization`. يمكن تغيير اللغة من قائمة المستخدم بين العربية والإنجليزية، ويتغير اتجاه الواجهة تلقائيًا RTL/LTR.
